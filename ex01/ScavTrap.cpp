...
} // --> Default constructor for ScavTrap and ClapTrap
...
} // --> Parameterized constructor for ScavTrap and ClapTrap

ScavTrap::ScavTrap(ScavTrap const & other) : ClapTrap(other) {
    std::cout << "ScavTrap " << this->name << " copy constructor called" << std::endl;
} // --> Copy constructor for ScavTrap and ClapTrap
...
ScavTrap & ScavTrap::operator=(ScavTrap const & other) {
    ...
    return *this;
} // --> Copy assignment operator for ScavTrap and ClapTrap

ScavTrap::~ScavTrap() {
    std::cout << "ScavTrap " << this->name << " destructor called" << std::endl;
} // --> Destructor for ScavTrap and ClapTrap
...
} // --> attack method overridden for ScavTrap


void ScavTrap::guardGate() {
    std::cout << "ScavTrap " << name << " is now in Gate Keeper mode." << std::endl;
} // --> guardGate method for ScavTrap
